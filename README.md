...
* System Context & System Landscape diagrams
  * Import: `!include https://raw.fastgit.org/udegg/C4-PlantUML/master/C4_Context.puml`
  * Macros: 
...
* Container diagram
  * Import: `!include https://raw.fastgit.org/udegg/C4-PlantUML/master/C4_Container.puml`
  * Additional Macros: 
...
* Component diagram
  * Import: `!include https://raw.fastgit.org/udegg/C4-PlantUML/master/C4_Component.puml`
  * Additional Macros: 
...
* Dynamic diagram
  * Import: `!include https://raw.fastgit.org/udegg/C4-PlantUML/master/C4_Dynamic.puml`
  * Additional Macros: 
...
* Deployment diagram
  * Import: `!include https://raw.fastgit.org/udegg/C4-PlantUML/master/C4_Deployment.puml`
  * Additional Macros: 
...
```plantuml
@startuml
!include https://raw.fastgit.org/udegg/C4-PlantUML/master/C4_Context.puml
...
```plantuml
@startuml
!include https://raw.fastgit.org/udegg/C4-PlantUML/master/C4_Deployment.puml
